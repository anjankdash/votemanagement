 ...
 */
public class VpVoteInTiedStateOfMotionTest {
	...
	@Test
	public void VpVoteInTiedStateOfMotionTest_test() throws MotionInTiedStateException, InvalidVoteException, DuplicateVoteException, MaxVoteReachedException, MotionCanNotBeClosedException {
		mot.open();
		...
		mot.castVote( new VoteImpl( ApplicationConstants.VP_VOTER_ID, motionID, VoteStateEnum.NAYS));
		
		assertTrue("State of the Motion Before VP vote is CLOSED : ", (mot.getCurrentState() == MotionStateEnum.CLOSED) );
